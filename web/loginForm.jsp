...
<div class="limiter">
    <div class="container-login100">
        <div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-50">
            <form class="login100-form validate-form" action="${pageContext.request.contextPath}/login?action=login" method="post">
                ...
                <div class="text-center">
						<span class="txt1">
							Create an account?
                             <a href="${pageContext.request.contextPath}/login?action=registerForm" class="txt2 hov1">Sign up</a>
