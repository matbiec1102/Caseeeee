    ...
    <div class="container d-flex">
        ...
        <nav class="nav-menu d-none d-lg-block">
            <ul>
                ...
                <li class="active"><a
                        href="${pageContext.request.contextPath}/order?action=showCart&id=${requestScope['user'].getId()}">Cart</a>
                </li>
                <li class="active"><a
                        href="${pageContext.request.contextPath}/user?action=showDetailUser&id=${requestScope['user'].getId()}">Detail
                    User</a>
                </li>
                <li class="active"><a href="${pageContext.request.contextPath}/login?action=logout">Logout</a></li>
            </ul>
        </nav>
    </div>
</header>
