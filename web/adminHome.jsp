    ...
    <div class="container d-flex">
        ...
        <nav class="nav-menu d-none d-lg-block">
            <ul>
                ...
                <li class="active"><a href="${pageContext.request.contextPath}/bookManager">Book Manager</a></li>
                <li class="active"><a href="${pageContext.request.contextPath}/userManager">User Manager</a></li>
                <li class="active"><a href="${pageContext.request.contextPath}/order">Order Manager</a></li>
                <li class="active"><a href="${pageContext.request.contextPath}/login?action=logout">Log Out</a></li>
            </ul>
        </nav>
    </div>
